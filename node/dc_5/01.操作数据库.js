...
// 向 tb_user 表中，新增一条数据，其中 username 的值为 Spider-Man，password 的值为 pcc123
/* const user = { username: 'Spider-Man', password: 'pcc123' }
// 定义待执行的 SQL 语句
const sqlStr = 'insert into tb_user (username, password) values (?, ?)'tb_user
// 执行 SQL 语句
...
// 标记删除
/* const sqlStr = 'update tb_user set status=? where id=?'
